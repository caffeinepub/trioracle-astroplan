        ...
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="predictions" className="mt-0">
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              {sectionLevel >= 3 || (auth?.isAdmin ?? false) ? (
                result ? (
                  <PredictionPanel
                    cellCounts={result.cellCounts}
                    basicNumber={result.basicNumber}
                ...
                <div
                  ...
                  data-ocid="vedic_predictions.locked.card"
                >
                  <Lock
                  ...
                  <p
                    ...
                    style={{ color: "oklch(var(--muted-foreground))" }}
                  >
                    Predictions are available for Advanced subscribers. Please
                    login with an Advanced account.
                  </p>
                  <Button
                    onClick={() => openLoginModal(false)}
                    data-ocid="vedic_predictions_login.primary_button"
