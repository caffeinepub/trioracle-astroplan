...
function CourseCard({
  ...
  return (
    ...
    >
      {/* Card Header — two-column layout matching screenshot */}
      <div className="p-6 pb-4">
        <div className="flex items-start justify-between gap-4">
          {/* Left column: name + icon pill + tagline */}
          <div className="flex-1 min-w-0">
            <h3 className="font-serif text-2xl font-bold text-charcoal leading-tight mb-3">
              {course.name}
            </h3>
            <div className="flex items-start gap-3 mb-2">
              {/* Icon in rounded pill/oval container */}
      ...
      {/* Syllabus toggle — teal/sage green text with chevron */}
