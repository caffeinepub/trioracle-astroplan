          ...
          <form onSubmit={handleSubmit} className="space-y-5 pt-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {palmPhotos.map((file, idx) => (
                    <div key={idx} className="relative group">
                      ...
                      <span className="absolute bottom-0.5 left-0.5 text-[9px] bg-black/40 text-white rounded px-1">
                        {idx + 1}
                      </span>
                    </div>
                  ))}
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="e.g. Will I have financial stability? What are my relationship patterns? What career suits me best?"
                rows={3}
            ...
            <div>
              ...
              <Textarea
                ...
                placeholder="Share any significant past events, recurring patterns, or experiences you'd like us to consider in your reading..."
                rows={3}
                className="text-sm border-gold/20 focus:border-gold/50 resize-none bg-white/70"
              />
            </div>
