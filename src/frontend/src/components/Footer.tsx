...
export default function Footer() {
  ...
  const appId = encodeURIComponent(typeof window !== 'undefined' ? window.location.hostname : 'astropulsee-destiny');
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <div className="font-serif text-xl font-bold text-gold">Astropulsee</div>
                <div className="font-serif text-sm font-bold text-cream-bg/50">-destiny</div>
              </div>
            </div>
        ...
        <div className="border-t border-cream-bg/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-cream-bg/30">
            © {year} <strong className="font-bold text-cream-bg/40">Astropulsee-destiny</strong>. All rights reserved.
          </p>
