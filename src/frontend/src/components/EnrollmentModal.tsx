...
export default function EnrollmentModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Encode email into question field so admin can see it (consistent [EMAIL:xxx] format)
    ...
    try {
      await submitMutation.mutateAsync({
        serviceType: BigInt(100 + course.id),
        ...
        <div className="p-6">
          ...
          <div className="mb-6 pr-8">
            ...
            <h2
              ...
              className="font-serif text-2xl font-bold text-charcoal leading-tight"
            >
